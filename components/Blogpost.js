  ...
  return(
    <Link passHref href={`/blogposts/${blogpost.slug}`}>
      <div key={blogpost.slug} 
          className="flex flex-col items-center justify-center w-full md:w-[48%] font-bold rounded-lg drop-shadow-xl cursor-pointer h-64 md:h-80 bg-zinc-200 dark:bg-zinc-800 md:hover:scale-110 md:transition-transform md:ease-in-out">
